export const LinkCard = ({ label, href, icon, className }) => (
  <a
    className={`ring-1 ring-zinc-700 hover:ring-zinc-500/80 transition-all ease-in-out p-2 px-3 bg-zinc-800 hover:bg-zinc-700 shadow hover:shadow-lg rounded-lg flex flex-row items-center ${className} group`}
    href={href}
  >
