export const LinkCard = ({ label, href, icon, className }) => (
  <a
    className={`border border-zinc-700 hover:border-zinc-500/80 border-solid transition-all ease-in-out p-2 bg-zinc-800 hover:bg-zinc-700 shadow hover:shadow-lg rounded-lg flex flex-row items-center ${className} group`}
    href={href}
  >
