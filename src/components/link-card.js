export const LinkCard = ({ label, href, icon, className }) => (
  <a
    className={`ring-1 ring-zinc-700 hover:ring-zinc-500/80 transition-all duration-300 ease-in-out p-2 px-3 backdrop-blur bg-zinc-800/50 hover:bg-zinc-700/50 shadow hover:shadow-lg rounded-lg flex flex-row items-center ${className} group`}
    href={href}
  >
